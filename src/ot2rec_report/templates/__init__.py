...
nb_aretomo_header = read_ipynb("report_aretomo_header.ipynb")
nb_aretomo_recon = read_ipynb("report_aretomo_recon.ipynb")
nb_aretomo_align = read_ipynb("report_aretomo_align.ipynb")
